                            ...
                            alertInfo.map((alert,index) => {
                                return (
                                    <React.Fragment key={alert.id}>
                                        ...
                                        <CAlert color={alert.color} className="alert-dismissible animated slideInDown fixed-top" style={{width:"max-content",zIndex:9999,left:"unset",right:12,top:12,marginTop:(54*index)}}>
                                            {alert.message}
